...
@section('container')
    ...
    <form action="{{route('schools.update',$school->id)}}" method="post">
        ...
        <div class="row">
            ...
            <input type="text" name="School" value="{{$school->School}}" class="form-control" placeholder="School">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Village</strong>
                    <input type="text" name="Village" value="{{$school->Village}}" class="form-control" placeholder="Village">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
